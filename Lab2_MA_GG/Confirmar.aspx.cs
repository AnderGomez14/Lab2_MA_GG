        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (logica.confirmar(Request.QueryString["mbr"], Request.QueryString["numconf"]))
                    div.InnerHtml = "Cuenta verificada con exito, haga click <a href='index.aspx'>aqui</a> para iniciar sesion.<br/><br/><img src='https://media.giphy.com/media/m2Q7FEc0bEr4I/giphy.gif' style='display: block;margin-left: auto;margin-right: auto;'>";
                else
